...
//                 double y = ApplicationSettingHelper.TryGetValueWithDefault<double>(AccelerometerCalibrationKeyName + "Y", 0);
                 return new Simple3DVector(0, 0, 0);
            }
...
//                 }
        ...
        /// </summary>
        public Simple3DVector ZeroAccelerationCalibrationOffset { get{return new Simple3DVector(0, 0, 0);} private set{ZeroAccelerationCalibrationOffset=value;} }
        ...
        private void StartAccelerometer()
        {
            try
            {
                ...
                if (_sensor != null)
                {
                    _sensor.ReadingChanged += sensor_CurrentValueChanged;
                    //_sensor.Start();
                    _active = true;
                    NoAccelerometer = false;
                }
...
//                     _sensor.Stop();
        ...
        private void sensor_CurrentValueChanged(object sender, AccelerometerReadingChangedEventArgs et)
        {
            var e = et.Reading;
            ...
            Simple3DVector rawAcceleration = new Simple3DVector(e.AccelerationX, e.AccelerationY, e.AccelerationZ);
